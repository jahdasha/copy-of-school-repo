  ...
  render(){
    ...
    return (
      <li id={this.props.item._id}>
        <span className="single-item">The {this.props.item.text} is in {this.props.item.itemLocation}</span>  <a className="babyItem" href={`/items/${this.props.item._id}`}>edit</a>
