...
// get method to retrieve all of the quotes in the database
...
// post method to allow the user to input new quotes into the database
...
// delete method to allow the user to delete the selected quote from the db
