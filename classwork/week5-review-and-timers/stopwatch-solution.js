...
var stopwatch = {
  ...
  start: function(){
    counter = setInterval(stopwatch.count, 1000); //Tip: 1000 ms = 1 second.
  },
  stop: function(){
  ...
  count: function(){
    stopwatch.time++;
    var converted = stopwatch.timeConverter(stopwatch.time);
    $('#display').html(converted); // if you use append here it will concatinate the time to the end (dont use append)
  },
