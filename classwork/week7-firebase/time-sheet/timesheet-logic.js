...
*/
// 1. Link to Firebase
var employeeData = new Firebase("https://employee-database.firebaseio.com/");
...
$("#addEmployeeBtn").on("click", function(){
	...
	var empStart = moment($("#startInput").val().trim(), "MM/DD/YY").format("X");
	...
	// add a unique id for each new employee in firebase
